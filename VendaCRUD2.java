 ...
 * @author Jairo
 */
public class VendaCRUD2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (acao == null) {
            ...
            rd = request.getRequestDispatcher("/venda2.jsp");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(VendaCRUD2.class.getName()).log(Level.SEVERE, null, ex);
