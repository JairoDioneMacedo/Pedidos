 ...
 * @author Jairo
 */
public class PedidosPendentes1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("/pedidospendentes1.jsp");
            rd.forward(request, response);
        } catch (SQLException ex) {
            Logger.getLogger(PedidosPendentes1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
