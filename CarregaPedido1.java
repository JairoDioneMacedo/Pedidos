 ...
 * @author Jairo
 */
public class CarregaPedido1 extends HttpServlet {
...
*/
        ...
        try {
            ...
            Logger.getLogger(CarregaPedido1.class.getName()).log(Level.SEVERE, null, ex);
        }

        RequestDispatcher rd = request.getRequestDispatcher("alterapedidos1.jsp");
