 ...
 * @author Jairo
 */
public class VendaCRUD1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (acao == null) {
            ...
            rd = request.getRequestDispatcher("/venda1.jsp");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(VendaCRUD1.class.getName()).log(Level.SEVERE, null, ex);
